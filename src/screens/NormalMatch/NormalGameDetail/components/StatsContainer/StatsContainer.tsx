...
import { NormalGameTurnStats, ThrowCount, ThrowStats } from '~/lib/game_stats_helper.ts';

interface ScoreContainerProps {
  textSize: number;
  turnStats: NormalGameTurnStats;
...
export const StatsContainer: FC<ScoreContainerProps> = ({
  textSize,
  turnStats,
  throwStats,
  mostThrown,

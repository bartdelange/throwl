...
import { makeStyles } from './ScoreTable.styles.tsx';
...
import { AppLogoArrowLight } from '~/components/AppLogo/index.ts';
import { SwipeActions } from '~/components/Swipeable/SwipeActions.tsx';

interface ScoreTableProps {
    scoreTableRef: React.RefObject<FlatList | null>;
    turns: Turn[];

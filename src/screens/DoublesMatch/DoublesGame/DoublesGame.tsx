...
import { useStyles } from '~/screens/DoublesMatch/DoublesGame/styles.ts';
...
import { ScoreTable } from '~/screens/DoublesMatch/DoublesGame/ScoreTable/ScoreTable.tsx';
import { GameService } from '~/services/game_service.ts';
import { useDoublesGameController } from '~/hooks/useDoublesGameController.ts';
import { Turn } from '~/models/turn.ts';

export const DoublesGameScreen: FC = () => {
  const navigation = useNavigation<NativeStackNavigationProp<RootStackParamList>>();
  const route = useRoute<RouteProp<RootStackParamList, typeof DOUBLES_GAME_SCREEN>>();

  ...
  return (
    <Grid style={styles.scoreTable}>
      <Row style={styles.scoreTableHead}>
        ...
        <Col style={styles.scoreTableCol} size={1}>
          <Text style={[styles.scoreTableCell, styles.scoreTableCenterCell]}>Avg. per D.</Text>
        </Col>
        <Col style={styles.scoreTableCol} size={1}>
          <Text style={[styles.scoreTableCell, styles.scoreTableCenterCell]}>On curr. D.</Text>
        </Col>
      </Row>

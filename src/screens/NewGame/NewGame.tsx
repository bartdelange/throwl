...
import { GameModeScreen } from '~/screens/NewGame/GameMode/GameMode.tsx';
import { GameOptionsScreen } from '~/screens/NewGame/GameOptions/GameOptions.tsx';
import { PlayerSelectScreen } from '~/screens/NewGame/PlayerSelect/PlayerSelect.tsx';
import { NewGameProvider } from '~/context/NewGameContext';
import { AppBar } from '~/components/AppBar/AppBar.tsx';
import { useRoute } from '@react-navigation/native';
import { RouteProp } from '@react-navigation/core';
import { RootStackParamList } from '#/navigation.ts';
...
export const NewGameScreen: FC = () => {
  ...
  return (
    <NewGameProvider initialState={{ options: gameOptions, mode: gameOptions?.mode }}>
      <StepStack.Navigator
        screenOptions={{
          header: props => <AppBar {...props} />,
        }}
      >
        <StepStack.Screen name={GameFlowStackNames.GAME_MODE} component={GameModeScreen} />
        <StepStack.Screen name={GameFlowStackNames.GAME_OPTIONS} component={GameOptionsScreen} />
        <StepStack.Screen

            ...
            <View style={styles.scoreInput}>
              ...
              <Row>
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}1`)
                    }>
                ...
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}2`)
                    }>
                ...
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}3`)
                    }>
              ...
              <Row>
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}4`)
                    }>
                ...
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}5`)
                    }>
                ...
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}6`)
                    }>
              ...
              <Row>
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}7`)
                    }>
                ...
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}8`)
                    }>
                ...
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() =>
                      setGameStartingScore(current => +`${current}9`)
                    }>
              ...
              <Row>
                <Col>
                  <TouchableRipple
                    style={styles.scoreButton}
                    onPress={() => setCustomGameScoreOpen(false)}>
                    <Text style={styles.scoreButtonText}>Accept</Text>
                  </TouchableRipple>
                </Col>
              </Row>
            </View>
